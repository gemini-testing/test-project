        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              BookStore is your one-stop destination for books across all genres. 
              We believe in the power of reading and aim to make books accessible to everyone.
            </p>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link 
                  to="/shipping" 
                  className="text-gray-300 hover:text-primary-300 transition-colors"
                  data-testid="shipping-info-link"
                >
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="flex-grow px-4 py-2 rounded-l text-secondary-900 focus:outline-none focus:ring-2 focus:ring-primary-500"
                data-testid="newsletter-input"
              />
              <button
                type="submit"
                className="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-r font-medium transition-colors"
